...
const Card = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-slate-200/90 bg-white text-slate-900 shadow-xs dark:border-slate-800/90 dark:bg-slate-900/70 dark:text-slate-100 transition-all",
      className
    )}
    {...props}
  />
